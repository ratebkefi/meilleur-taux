...
use Admin\BackendUserBundle\Manager\UserManager;
...
abstract class AbstractWebTestCase extends KernelTestCase
{
    ...
    public static function setUpBeforeClass($httpHost = 'http://api.admin.dev')
    {
        static::$httpHost = $httpHost;
    }


    public function removeDocument($document, $model = 'Admin\ReviewBundle\Document\Node')
    {
