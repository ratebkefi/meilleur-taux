...
namespace Admin\FrontendUserBundle\Manager;

use Symfony\Component\Security\Core\User\UserInterface;
use Symfony\Component\Security\Core\User\UserProviderInterface;
use Symfony\Component\Security\Core\Exception\UnsupportedUserException;
use Admin\FrontendUserBundle\Document\FrontendUser;
use Admin\ResourceBundle\Utility\PasswordUtility;
use LogicException;
...
class UserManager implements UserProviderInterface
{
    ...
    public function registerUser(array $userData)
    {
        ...
        if (!$user) {
            ...
            $user->setPlainPassword($userData['password']);
            $user->setEnabled($userData['enabled']);
            $user->setGroupe($userData['groupe']);
                ...
                $message = \Swift_Message::newInstance()
                    ...
                    ->setBody(
                        $this->templating->render(
                            'AdminFrontendUserBundle:Email:registration.txt.twig',
                            array(
        ...
        if ($user) {
            ...
            try {
                $message = \Swift_Message::newInstance()
                    ...
                    ->setBody(
                        $this->templating->render(
                            'AdminFrontendUserBundle:Email:newPassword.txt.twig',
                            array(
                                'username' => $user->getUsername(),
                                'password' => $password,
                            )
    ...
    {
        $name = 'Admin\FrontendUserBundle\Document\FrontendUser';
