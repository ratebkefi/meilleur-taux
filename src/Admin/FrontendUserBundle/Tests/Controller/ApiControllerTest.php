...
namespace Admin\FrontendUserBundle\Tests\Controller;

use Admin\ResourceBundle\Tests\AbstractWebTestCase;
...
class ApiControllerTest extends AbstractWebTestCase
{
    ...
    public function testRegisterUserAction()
    {
        $data = [
            ...
            'email' => rand(11111111, 999999999) . '@admin.co'
        ];
    ...
    public function testUserForgotPasswordUserNotFoundAction()
    {
        $this->client->request(
            'GET',
            '/' . $this->api['frontend'] . '/user/password/forgot/?email=fontenduser@admin.co',
            [],
            [],
            ['CONTENT_TYPE' => 'application/json']
        );
