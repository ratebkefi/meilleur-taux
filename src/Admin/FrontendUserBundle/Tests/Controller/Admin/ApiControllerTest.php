...
namespace Admin\FrontendUserBundle\Tests\Controller\Admin;

use Admin\ResourceBundle\Tests\AbstractBackendWebTestCase;
...
class ApiControllerTest extends AbstractBackendWebTestCase
{
    ...
    public function testPostUserAction()
    {
        $users = $this
            ->dm
            ->getRepository('Admin\FrontendUserBundle\Document\FrontendUser')
            ->findBy(['username' => 'test_frontend_user_admin']);
        ...
        $data = [
            'username' => 'test_frontend_user_admin',
            'email' => 'test_frontend_user_admin@admin.co',
            'plain_password' => 'test_frontend_user_admin',
        ];
    ...
    public function testGetUserAction()
    {
        $user = $this
            ->dm
            ->getRepository('Admin\FrontendUserBundle\Document\FrontendUser')
            ->findOneBy(['username' => 'test_frontend_user_admin']);
        $id = $user->getId();
