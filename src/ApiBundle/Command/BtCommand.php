...
class BtCommand extends ContainerAwareCommand
{
    private $output;
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->output = $output;
            ...
            $html = @file_get_contents("http://www.bt.com.tn/change"); //getting the file content

            $banque = $repository->getRepository('ApiBundle:Banque')->findOneBy(array('raison_social' => 'BT'));
        if(!$html){
            $logs = new Logs();
