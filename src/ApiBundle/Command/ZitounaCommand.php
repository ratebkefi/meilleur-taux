...
class ZitounaCommand extends ContainerAwareCommand
{
    private $output;
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $html = @file_get_contents("http://www.banquezitouna.com/Fr/convertisseur-de-devise_64_103"); //getting the file content
        $banque = $repository->getRepository('ApiBundle:Banque')->findOneBy(array('raison_social' => 'Zitouna'));
        if(!$html){
            $logs = new Logs();
        ...
        //$html = file_get_contents("http://www.banquezitouna.com/Fr/convertisseur-de-devise_64_103");
        $crawler = new Crawler($html);
        $link = $crawler->filter('td');
        $i=-2;
        $j=0;
        $array_receive= array();
