...
class BiatCommand extends ContainerAwareCommand
{
    private $output;
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->output = $output;
        $html = @file_get_contents("http://www.biat.com.tn/biat/cours_devise.jsp"); //getting the file content
        $banque = $repository->getRepository('ApiBundle:Banque')->findOneBy(array('raison_social' => 'BIAT'));
        ...
        //$html = file_get_contents("http://www.biat.com.tn/biat/cours_devise.jsp");
        $crawler = new Crawler($html);
        $link = $crawler->filter('tr.fontdevise1 > td ');
        $i=0;
        $j=0;
        $array_receive= array();
