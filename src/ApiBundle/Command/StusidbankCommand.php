...
class StusidbankCommand extends ContainerAwareCommand
{
    private $output;
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $em = $this->getContainer()->get('doctrine.odm.mongodb.document_manager');
            ...
            $html = @file_get_contents("http://www.stusidbank.com.tn/site/publish/content/article.asp?id=78"); //getting the file content
            $banque = $repository->getRepository('ApiBundle:Banque')->findOneBy(array('raison_social' => 'STUSID BANK'));
